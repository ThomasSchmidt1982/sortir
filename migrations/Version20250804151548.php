 ...
 */
final class Version20250804151548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etat_id INT NOT NULL, ADD lieu_id INT NOT NULL, ADD organisateur_id INT NOT NULL, DROP etat');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etat VARCHAR(100) NOT NULL, DROP etat_id, DROP lieu_id, DROP organisateur_id');
    }
}
